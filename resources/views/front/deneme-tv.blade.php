    ...
    <section class="section details">
        ...
        <div class="container">
            <div class="row">
                ...
                {{-- @foreach($tv_show->trailers as $source)--}}
                    ...
                    <div class="card card--details card--series align-content-center">
                            ...
                            <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-9">
                                <div class="card__content">
                                    <div class="card__wrap">
                                        ...
                                        <iframe id="video" src="{{$tv_show->source}}" width="854" height="480" frameborder="0"
                        ...
                        <ul class="card__list">
                            <li style="line-height:20px; width: 70px; height:35px; font-size:16px;"><i
                                    class="ion-ios-eye">  </i>  <span class="ms-5">{{$tv_show->visits}}</span> </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="reviews">
                                        ...
                                        <form action="{{route('front.error.submit', $tv_show->id)}}" class="form" method="post">
                                            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4 col-md-4 col-lg-3 col-xl-3">
                                <div class="card__cover">
                                    <img src="https://image.tmdb.org/t/p/w500{{$tv_show->poster_path}}" alt="{{$tv_show->name}} izle">
                                </div>
                            </div>
                            <!-- end card cover -->
                            ...
                            <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-9">
                                <div class="card__content">
                                    <div class="card__wrap">
                                        <span class="card__rate"><i class="icon ion-ios-star"></i>{{$tv_show->rating}}</span>

                                        <ul class="card__list">
                                            <li>{{$tv_show->video_format}}</li>
                                        </ul>
                                    </div>
                                    ...
                                    <ul class="card__meta">
                                        ...
                                        <li><span>Yapım yılı:</span> {{$tv_show->release_date}}</li>
                                        <li><span>Süre:</span>{{$tv_show->runtime}} dk. </li>
                                        <li><span>Oyuncular:</span>
                                            @foreach($tv_show->casts as $cast)
...
{{--                    <livewire:front.comments :tv_show="$tv_show" />--}}
