...
<head>
    ...
    <meta name="title" content="Kayıt Ol {{siteInfo()->site_separator}} {{siteInfo()->site_name}}">
    ...
    <meta property="og:title" content="Kayıt Ol {{siteInfo()->site_separator}} {{siteInfo()->site_name}}">
    <meta property="og:description" content="{{siteInfo()->site_description}}">
    <meta property="og:image" content="{{siteInfo()->site_logo}}">
    <meta property="og:url" content="{{Request::url()}}">
    <title>Kayıt Ol {{siteInfo()->site_separator}} {{siteInfo()->site_name}}</title>
            ...
            <div class="col-12">
                <div class="sign__content">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="sign__form">
                        ...
                        <div class="sign__group">
                            <input id="password-confirm" type="password" class="sign__input" placeholder="Şifrenizi Tekrar Girin" name="password_confirmation" required autocomplete="new-password">
